...
console.log("tracker num ", trackernum)
    ...
    if (!params.ignoreForumNames) {
        params.ignoreForumNames = ["secret", "old maths", "absentee", "relationships", "completed", "math", "season 1", "season 2", "season 3", "season 4", "season 5", "season 6", "season 7", "season 8", "season 9", "season 10", "season 11", "season 12", "season 13", "season 14", "season 15", "season 16", "season 17", "season 18", "season 19", "season 20", "the bulletin", "clubs", "events", "subplots", "the utilities", "templates", "processing", "incomplete", "claims", "abstruse", "witch", "shifter", "werewolf", "fae", "merfolk", "vampire", "spirit", "mythical", "faculty", "townsfolk", "platonic", "family", "romance", "groups", "mixed", "ayo", "castle", "emily", "exodin", "ina", "io", "j", "joei", "nyorobon", "kismyth", "lili", "manda", "mina", "molly", "moth", "silv", "shadow", "tecri", "tolvagary", "turtle", "yuen", "mish", "old stuff", "dev challenges", "the darkest timeline", "eykta", "crystal", "time lapse", "subgroups", "applications", "misc", "the archives", "year 1", "year 2", "year 3", "year 4", "year 5", "previous events", "6 months!", "general", "wonderland"];
    }
